    ...
    <body class="has-navbar-fixed-top">
        ...
        <section class="main-content columns is-fullheight">
                ...
                <div class="section">
                    <div class="card">
                        <div class="card-header is-header-dark">
                            <p class="card-header-title is-header-title-dark"><i class="fas fa-newspaper fa-sm" aria-hidden="true"></i>&nbsp;Updates</p>
                            <a href="#" class="card-header-icon" aria-label="more options">
                            <span class="new-post"><i class="fas fa-plus" aria-hidden="true"></i></span>
                            </a>
                        </div>
            ...
            <aside class="column is-3 is-narrow-mobile is-fullheight section">
                <nav class="panel">
                    <p class="panel-heading is-header-dark">Latest Topics</p>
